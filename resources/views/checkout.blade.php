    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12" >
                ...
                <div>
                    <a class="btn btn-primary" href="{{url('/payment/process')}}" id="confirm_order_btn">Confirm Order</a>
                    <p style="color:red; text-align:left">
                    <strong>Note:</strong><br />
                    <small>This is only a demo application and as such you can buy books without using any real cash.<br />
                      No real money will be charged and no real product and/or services will be delivered.</small><p>
                </div>
            </div>
        </div>
    </div>
